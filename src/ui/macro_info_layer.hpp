...
class MacroInfoLayer : public geode::Popup {
    ...
    bool init() {
        ...
        lbl = CCLabelBMFont::create(geode::utils::numToString(g.macro.framerate).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        ...
        std::string duration = g.macro.inputs.empty() ? std::string("0s") : (geode::utils::numToString(g.macro.inputs.back().frame / g.macro.framerate) + "s");
        ...
        std::string seed = g.macro.seed != 0 ? geode::utils::numToString(g.macro.seed) : std::string("N/A");
        ...
        std::string levelID = g.macro.levelInfo.id != 0 ? geode::utils::numToString(g.macro.levelInfo.id) : "";
        ...
        lbl = CCLabelBMFont::create((g.macro.botInfo.name + " " + getModVersionString()).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        ...
        lbl = CCLabelBMFont::create(geode::utils::numToString(g.macro.inputs.size()).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[0][0][0]) + " / " + geode::utils::numToString(playerInputs[0][0][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[0][1][0]) + " / " + geode::utils::numToString(playerInputs[0][1][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[0][2][0]) + " / " + geode::utils::numToString(playerInputs[0][2][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[1][0][0]) + " / " + geode::utils::numToString(playerInputs[1][0][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[1][1][0]) + " / " + geode::utils::numToString(playerInputs[1][1][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
        ...
        lbl = CCLabelBMFont::create((geode::utils::numToString(playerInputs[1][2][0]) + " / " + geode::utils::numToString(playerInputs[1][2][1])).c_str(), "chatFont.fnt");
        lbl->setAnchorPoint({ 0, 0.5 });
        lbl->setScale(0.55f);
